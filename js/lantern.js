...
lanternSlideshow.prototype.getEmbedCode = function(imageArray, lanternWidth, lanternSpeed) {
  ...
  var lanternStyleCode = '<style> #lanternSlideContainer {width:' + lanternWidth + ';position:relative;margin-left:auto;margin-right:auto;} .lanternSlide {position:relative;display:none;} .lanternSlide img{width:100%;} .lanternSlide a:active {outline: none;} </style><!--endLanternCode-->';
